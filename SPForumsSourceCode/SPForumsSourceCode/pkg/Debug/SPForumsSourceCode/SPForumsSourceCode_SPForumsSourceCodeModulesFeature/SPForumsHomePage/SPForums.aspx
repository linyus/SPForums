...
<asp:Content ID="Content5" ContentPlaceHolderID="PlaceHolderMain" runat="server">
    ...
    <table class="ms-core-tableNoSpace ms-webpartPage-root" width="100%">
        <tr>
            ...
            <td id="Td2" name="_invisibleIfEmpty" valign="top" width="90%" height="100%" width="100%" style="padding-left: 20px">
                <WebPartPages:WebPartZone runat="server" Title="loc:Body" ID="Body" FrameType="TitleBarOnly">
                    <ZoneTemplate></ZoneTemplate>
                </WebPartPages:WebPartZone>
            </td>
        </tr>
